...
var express	= require('express'),					// used as middleware
	...
	connect = mysql.createConnection({
		...
		password: 	'Madhatter26',					// Password to log into the DB, Change where appropriate. 
		database: 	'tetradb',						// Database to be interfaced with. 
    }),
...
io.sockets.on('connection', function(socket){
	...
	socket.on('send message',function(data){
		...
		if(typeof data.college != 'undefined'){
			...
			socket.emit('new message', {summary: output.summary, sentences: output.sentences});
		}else{ 
